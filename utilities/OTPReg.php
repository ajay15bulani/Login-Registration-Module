					...
					<form class="form-signin" name="f1" id="f1" method="POST" class="form-horizontal">
						...
						<div class="form-group">	
							...
							<div class="input-group input-group-md">
								<span class="input-group-addon">+91</span><input onkeyup="document.getElementById('mob_err').innerHTML=''" type="number" name="Mobile"  id="Mobile" maxlength="10" value="<?php
                                    if(isset($_POST['mob'])&&!empty($_POST['mob']))
                                    echo $_SESSION['mob'];?>" placeholder="Enter Your Mobile Number Here.." class="form-control" required>
							</div>
						</div>	
                        <small id="mob_err" style="color:#a94442"></small>
                        <br/>
                        <br/>
						<div id="sb"><input type="submit" name="submit" class="btn btn-lg btn-primary btn-block" value="Generate OTP"/></div>		
					</form>
				</div>
			</div>
		</div>
