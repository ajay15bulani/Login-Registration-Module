<?php
if(!isset($_GET['mob'])||!isset($_GET['otp']) || empty($_GET['otp']) || empty($_GET['mob']))
{
    echo "<h1 align='center' color='red'>Access Denied</h1>";
    exit();
}
...
$seven_bit_msg = "Your OTP For ".$type." is ".$otp;
