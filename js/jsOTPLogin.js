...
function resetOTP(time)
{
    timer=setTimeout(function(){
        ...
        window.location="http://telecomacademy.co.in";
    },time);
}
...
function VerifyNumber()
{
    ...
    AjaxObj.onreadystatechange=function()
    {
        if(AjaxObj.readyState==4 && AjaxObj.status==200)
        {
            ...
            if(resp.charAt(0)!=1)
            {
                document.getElementById("mob_err").innerHTML="<b>No Such User Registered With Us</b>";
                return false;
            }
            else
            {
...
function OTPVerfiedSuccess()
{
    ...
    AjaxObj.open("POST","utilities/OTPSuccess.php",true);
