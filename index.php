                ...
                <div class="col-sm-6 col-md-4 col-md-offset-4">
                    <h2 class="text-center login title" align="center">Sign in to your account</h2>
                        <div class="account-wall well">
                            ...
                            <form class="form-signin" name="f1" id="f1" method="POST" class="form-horizontal">
                                ...
                                <a href="LoginViaOTP.php" class="text-center new-account">Login Through OTP</a>
                    ...
                    <center class="well">
                       ...
                       <a>
                            ...
                            <div class="fb-login-button" data-size="large" data-scope="public_profile,email" onlogin="checkLoginState();">Log in with Facebook</div>
                
                        </a>
                        
                        <a href="utilities/twitter_signin.php" style="top: 5px;" class="btn btn-block btn-social btn-xs btn-twitter">
                
                            <i class="fa fa-twitter"> </i>Log in with Twitter
                
                        </a>
                
                        <a href='utilities/linkdin-login.php' style="top: 5px;" class="btn btn-block btn-social btn-xs btn-linkedin">
                
                            <i class="fa fa-linkedin"></i>Log in with Linkedin
                
                        </a>
                
                        <a class="btn btn-block btn-social btn-xs btn-google" style="top: 5px;">
